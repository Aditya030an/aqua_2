...
export default function AboutPage() {
  return (
    <div className="bg-white text-[#1F212E] overflow-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative py-20 md:py-32 px-4 md:px-6 text-center">
        {/* Glow */}
        ...
        <p className="max-w-2xl mx-auto text-gray-500 text-base md:text-lg relative z-10">
        Aquahari is a platform dedicated to fish keeping, aquarium knowledge, and natural fish care — helping you build healthier aquariums with confidence.
...
<div className="relative z-10 max-w-3xl mx-auto">
  ...
  >
    ...
    <span className="text-[#4A9E78]">right knowledge</span>.
  </motion.h2>
  ...
  >
    Learn, explore, and build a healthier environment for your fish with
    Aquahari's expert guides, trusted products, and practical tips.
  </motion.p>
